...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, TextInput, Modal, ActivityIndicator, StatusBar, Alert } from 'react-native';
...
const OPDSchedulingScreen = ({ navigation }) => {
  ...
  return (
    <ClinicalCanvas style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {loading && upcomingAppointments.length === 0 ? (
          ...
          <View style={styles.emptyBox}>
            ...
            <Text style={styles.emptyText}>No outpatient sessions on this day.</Text>
          </View>
        ) : (
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Schedule OPD Consult</Text>
      ...
      <Modal visible={showPatientSelect} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { height: '80%' }]}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Select Patient</Text>
              <TouchableOpacity onPress={() => setShowPatientSelect(false)}>
                <X size={22} color={theme.colors.textSecondary} />
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  dateBar: {
    ...
    paddingHorizontal: theme.spacing.lg, gap: 10, borderBottomWidth: 1, borderBottomColor: '#E2E8F0',
  },
  dateTab: {
